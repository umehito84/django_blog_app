...
class PostModelTests(TestCase):
	"""TestCaseを継承したクラスの中で'test'で始めることで、
		Djangoがそれはテストメソッドであることを自動で認識してくれる。"""
	...
	def test_is_count_one(self):
		"""1つのレコードを適当に作成すると、レコードが1つだけカウントされることをテスト"""
	...
	def test_saving_and_retrieving_post(self):
		"""内容を指定してデータを保存し、すぐに取り出した時に保存したときと同じ値が返されることをテスト"""
		post = Post()
